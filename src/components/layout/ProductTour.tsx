...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    description:
      "You already know. Modern.Church connects your platforms into a single briefing tailored to your role. The lead pastor sees the full picture. The campus pastor sees their campus. No reports to pull, no spreadsheets to assemble.",
  ...
  },
  {
    ...
    iconColor: "text-violet-600",
    iconBg: "bg-violet-100 dark:bg-violet-900/30",
    title: "Trends You'd Miss",
    hook: "Attendance climbed three weeks in a row. Did anyone notice?",
    description:
